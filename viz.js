...
var scales =  {
    cases: {
        totals:  {
            ...
            color: [[1, 1000, 1000000], ["#fcde9c", "#e34f6f", "#0b5a86"]]
        },
        per_capita:  {
            title: "Percentage of positive tests per capita",
            labels: [0.00001, 0.0001, 0.001, 0.01, 0.1],
            color: [[0.001, 0.01, 0.1], ["#fcde9c", "#e34f6f", "#0b5a86"]]
        }
    },
    deaths: {
        totals:  {
            ...
            color: [[1, 100, 100000],  ["#E1EEE5", "#716BA5", "#bba934"]]
        },
        per_capita:  {
            title: "Percentage of deaths",
            labels: [0.00001, 0.0001, 0.001, 0.01, 0.1],
            color: [[0.0001, 0.0025, 0.01, 0.1], ["#E1EEE5", "#716BA5", "#bba934"]]
        }
    },
    vax: {
        totals:  {
